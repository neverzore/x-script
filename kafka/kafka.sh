kafka_home=/home/kafka02
broker_id=2
log_dirs=${kafka_home}/log01,${kafka_home}/log02,${kafka_home}/log03
zk_connect=localhost:2181/kafka,localhost:2182/kafka,localhost:2183/kafka
listeners=PLAINTEXT://:9094
mkdir -p ${kafka_home}/{log01,log02,log03}
